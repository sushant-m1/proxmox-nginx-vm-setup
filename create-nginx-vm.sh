...
ISO_PATH="jammy-server-cloudimg-amd64-disk-kvm.img"           # Name of the ISO file in /var/lib/vz/template/iso/
...
qm set $VMID --ide2 storage1:iso/jammy-server-cloudimg-amd64-disk-kvm.img,media=cdrom                    # Attach ISO to IDE2
